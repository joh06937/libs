...
###
 ...
 # @return none
 ##
function(_cmlib_kconfig_get_configs OUTPUT_NAME FILE)
...
###
 ...
 # @return none
 ##
function(_cmlib_kconfig_parse_config CONFIG NAME_OUTPUT_NAME VALUE_OUTPUT_NAME)
...
###
 ...
 # @return none
 ##
function(_cmlib_kconfig_check_needs_reinitialization OUTPUT_NAME PROJECT_FILES MASTER_CONFIG_FILE DUMMY_CONFIG_FILE)
...
###
 ...
 # @return none
 ##
function(cmlib_kconfig_configure KCONFIG_FILE PROJECT_FILES)
    ...
    _cmlib_kconfig_check_needs_reinitialization(reinitialize "${PROJECT_FILES}" "${masterConfigFile}" "${dummyConfigFile}")
    ...
    # Get the Kconfigs
    _cmlib_kconfig_get_configs(masterConfigs "${masterConfigFile}")

    foreach(masterConfig IN LISTS masterConfigs)
        # Get the configuration's name and value
        _cmlib_kconfig_parse_config("${masterConfig}" masterConfigName masterConfigValue)
    ...
    foreach(previousInternalConfig IN LISTS previousInternalConfigs)
        ...
        foreach(newInternalConfig IN LISTS newInternalConfigs)
            _cmlib_kconfig_parse_config("${newInternalConfig}" newInternalConfigName newInternalConfigValue)
